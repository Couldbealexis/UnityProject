namespace GoogleVR.HelloVR {
  ...
  public class dificilController : MonoBehaviour {
    ...
    public void OnCollisionEnter(Collision col)
    {
        Destroy(GameObject.FindWithTag("bullet"));
				scoreScript.setDificultad(3);
				scoreScript.initGame();
				instruccionesScript.hideLevels();
				scoreScript.setText();
				// Debug.Log(scoreScript.doorTag);
    }
